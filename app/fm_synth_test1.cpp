...
// (mfactor = 4.0). The modulation starts at 0.0 and slowly progresses to
// 1.0 (max). Then the cycle repeats with the modulation reset to 0.0. A
// reference sine wave is also generated to make it easy to sync the scope.
//
